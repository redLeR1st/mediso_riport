...
\Aref{tab:eredmeny_tab} táblázat második oszlopában a kiszegmentált bordák száma látható.
Szegmentált bordák alatt azokat értjük, melyek a már címkézett képen szegmentáltan szerepelnek, nem feltétlenül helyes címkével.
...
\centering
\end{table}
\section{A csigolyák szétválasztása bordák alapján}
...
Az 1-es számú címke az elsõ bordát, és az ahhoz tartozó csigolyát jelenti, és így sorba a többi.
...
\begin{figure}[h]
	...
	\centering
	\caption{Csontszegmentálás (1. eset)} \label{fig:korrig_1_1}
\end{figure}
\begin{figure}[h]
	\includegraphics[width=\scale\textwidth]{gerinc_2_7}
	\centering
	\caption{Gerinckijelölés (1. eset)} \label{fig:korrig_1_1}
\end{figure}
\begin{figure}[h]
	\includegraphics[width=\scale\textwidth]{szeg_3_7}
	\centering
	\caption{Régiónövelés (1. eset)} \label{fig:korrig_1_1}
\end{figure}
%\section*{2. eset}
%\begin{comment}
%-----------------------------------------
...
\begin{figure}[h]
	...
	\centering
	\caption{Csontszegmentálás (2. eset)} \label{fig:korrig_1_1}
\end{figure}
\begin{figure}[h]
	\includegraphics[width=\scale\textwidth]{gerinc_2_11}
	\centering
	\caption{Gerinckijelölés (2. eset)} \label{fig:korrig_1_1}
\end{figure}
\begin{figure}[h]
	\includegraphics[width=\scale\textwidth]{szeg_3_11}
	\centering
	\caption{Régiónövelés (2. eset)} \label{fig:korrig_1_1}
\end{figure}
%-----------------------------------------
\begin{comment}
%\section*{3. eset}
...
A zárójelben felsorolt képeken (
%\ref{fig:hatar_09},
\ref{fig:hatar_12}, \ref{fig:hatar_13}
%, \ref{fig:hatar_14}, \ref{fig:hatar_39}, \ref{fig:hatar_46}
) a csigolya közötti rések becslését láthatjuk a bordaalapú módszer segítségével.
A bordaalapú algoritmus eredménye a piros vonal mélység koordinátája.
...
%\label{fig:hatar_12}
\end{comment}
\caption{Csigolyák elválasztása bordák alapján (1. eset)} \label{fig:hatar_12}
\end{figure}
...
\end{minipage}%
\end{comment}
\caption{Csigolyák elválasztása bordák alapján (2. eset)} \label{fig:hatar_13}
%\label{fig:hatar_13}
\end{figure}
