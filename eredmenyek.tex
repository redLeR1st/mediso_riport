...
A zárójelben felsorolt képeken (\ref{fig:hatar_09}, \ref{fig:hatar_12}, \ref{fig:hatar_13}, \ref{fig:hatar_14}, \ref{fig:hatar_39}, \ref{fig:hatar_46}) a csigolya közötti rések becslését láthatjuk.
Az algoritmus eredménye a piros vonal mélység koordinátája.
...
\begin{figure}[h]
	\includegraphics[width=\scale\textwidth]{hatar_09}
	\centering
	\caption{Csigolyák közötti rések} \label{fig:hatar_09}
\end{figure}

\begin{figure}[h]
	\includegraphics[width=\scale\textwidth]{hatar_12}
	\centering
	\caption{Csigolyák közötti rések} \label{fig:hatar_12}
\end{figure}

\begin{figure}[h]
	\includegraphics[width=\scale\textwidth]{hatar_13}
	\centering
	\caption{Csigolyák közötti rések} \label{fig:hatar_13}
\end{figure}

\begin{figure}[h]
	\includegraphics[width=\scale\textwidth]{hatar_14}
	\centering
	\caption{Csigolyák közötti rések} \label{fig:hatar_14}
\end{figure}

\begin{figure}[h]
	\includegraphics[width=\scale\textwidth]{hatar_39}
	\centering
	\caption{Csigolyák közötti rések} \label{fig:hatar_39}
\end{figure}

\begin{figure}[h]
	\includegraphics[width=\scale\textwidth]{hatar_46}
	\centering
	\caption{Csigolyák közötti rések} \label{fig:hatar_46}
\end{figure}
