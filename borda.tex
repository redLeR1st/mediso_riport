...
\end{figure}
A módszer \aref{eq:var}-es egyenlet minimalizálásával találja meg az optimális \textit{t} küszöbértéket.
Szemléletesen pedig \aref{fig:otsu_hist} ábrán láthatjuk ahol a piros függõleges vonal az optimális küszöbértéket jelöli.
...
A keresés ugyan olyan módszerrel történik, mint az 4.3-as fejezetben leírt magpont meghatározás, azzal a különbséggel, hogy itt már biztosak lehetünk benne, hogy csak bordák fordulhatnak elõ.
